            ...
            child: new Column(
              children: <Widget>[
                ...
                new Container(
                  child: new Text(
                    "堡垒之夜吃鸡攻略",
                      style: new TextStyle(height: 1.4, fontSize: 20.0, color: GlobalConfig.fontColor) , textAlign: TextAlign.start
                  ),
...
//                      "回归运动\n\n三体定义的黑暗森林的宇宙格局，就是文明相互攻击和毁灭，越高级的，越明白藏好自己做好清理，绝不做探测对方文明的愚蠢行为。\n\n然而归还运动跳出了这个黑暗森林法则，不玩黑暗森林打击，不但探测别的宇宙文明，而且还深入了解对方文明，而且是全宇宙的所有文明。\n\n这是一种多么自信的科技实力呀，才能跳出黑暗森林的生存法则呀",
                        "1.学会搭板子\n\n进攻至少要学会用三连板，二连板太弱容易被人打下来。学会原地起高，占领高点再射杀敌人。还有打药的时候先用板子把自己围起来。\n\n2.学会切枪\n\n比较好用的是喷子切冲锋枪，一喷子把对手打残血，再用冲锋枪补伤害，如果对手反应速度不够快，甚至能够一波带走，十分实用。",
